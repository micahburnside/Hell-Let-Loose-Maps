//
//  StrongpointsMapsDataSource.swift
//  HLL Maps
//
...
class StrongpointsMapsDataSource: NSObject {
    ...
    func setup(dataSourceDelegate: DataSourceDelegate) {
        ...
        self.tableView.register(UINib(nibName: "StrongpointsMapsTableViewCell", bundle: nil), forCellReuseIdentifier: "StrongpointsMapsTableViewCell")
...
extension StrongpointsMapsDataSource: UITableViewDelegate {
...
extension StrongpointsMapsDataSource: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "StrongpointsMapsTableViewCell", for: indexPath) as! StrongpointsMapsTableViewCell
