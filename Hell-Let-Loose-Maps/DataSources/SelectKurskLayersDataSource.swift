...
func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
    ...
    _ = tableView.dequeueReusableCell(withIdentifier: "SelectKurskLayersTableViewCell", for: indexPath) as! SelectKurskLayersTableViewCell
}
}
...
func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
    ...
    title.text = "Kursk" // need array of strings
