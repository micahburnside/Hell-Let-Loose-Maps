...
//    let keyValueList = Bundle.main.url(forResource: "keyMap", withExtension: "json")
    ...
    enum ToggleSwitchKeys: String {
        case REMOVE_STRONGPOINT,
             ADD_STRONGPOINT,
             STRONGPOINT_CARENTAN_BLACTOT,
             STRONGPOINT_CARENTAN_502NDSTART,
             STRONGPOINT_CARENTAN_FARMRUINS,
             STRONGPOINT_CARENTAN_PUMPINGSTATION,
             STRONGPOINT_CARENTAN_RUINS,
             STRONGPOINT_CARENTAN_DERAILEDTRAIN,
             STRONGPOINT_CARENTAN_CANALCROSSING,
             STRONGPOINT_CARENTAN_TOWNCENTER,
             STRONGPOINT_CARENTAN_TRAINSTATION,
             STRONGPOINT_CARENTAN_CUSTOMS,
             STRONGPOINT_CARENTAN_RAILCROSSING,
             STRONGPOINT_CARENTAN_MOUNTHALAIS,
             STRONGPOINT_CARENTAN_CANALLOCKS,
             STRONGPOINT_CARENTAN_RAILCAUSEWAY,
             STRONGPOINT_CARENTAN_LAMAISONDESORMES,
             STRONGPOINT_DRIEL_OSTERBEEKAPPROACH,
             STRONGPOINT_DRIEL_ROSEANDERPOLDER,
             STRONGPOINT_DRIEL_KASTEELROSANDE,
             STRONGPOINT_DRIEL_BOATYARD,
             STRONGPOINT_DRIEL_BRIDGEWAY,
             STRONGPOINT_DRIEL_RIJNBANKS,
             STRONGPOINT_DRIEL_BRICKFACTORY,
             STRONGPOINT_DRIEL_RAILWAYBRIDGE,
             STRONGPOINT_DRIEL_GUNEMPLACEMENTS,
             STRONGPOINT_DRIEL_RIETVELD,
             STRONGPOINT_DRIEL_SOUTHRAILWAY,
             STRONGPOINT_DRIEL_MIDDELROAD,
             STRONGPOINT_DRIEL_ORCHARDS,
             STRONGPOINT_DRIEL_SCHADUWWOLKENFARM,
             STRONGPOINT_DRIEL_FIELDS,
             STRONGPOINT_ELALAMEIN_VEHICLEDEPOT,
             STRONGPOINT_ELALAMEIN_ARTILERYGUNS,
             STRONGPOINT_ELALAMEIN_MITEIRIYARIDGE,
             STRONGPOINT_ELALAMEIN_HAMLETRUINS,
             STRONGPOINT_ELALAMEIN_ELMREIR,
             STRONGPOINT_ELALAMEIN_WATCHTOWER,
             STRONGPOINT_ELALAMEIN_DESERTRATTRENCHES,
             STRONGPOINT_ELALAMEIN_OASIS,
             STRONGPOINT_ELALAMEIN_VALLEY,
             STRONGPOINT_ELALAMEIN_FUELDEPOT,
             STRONGPOINT_ELALAMEIN_AIRFIELDCOMMAND,
             STRONGPOINT_ELALAMEIN_AIRFIELDHANGARS,
             STRONGPOINT_ELALAMEIN_CLIFFSIDEVILLAGE,
             STRONGPOINT_ELALAMEIN_AMBUSHEDCONVOY,
             STRONGPOINT_ELALAMEIN_QUARRY,
             ...
             STRONGPOINT_SAINTEMEREEGLISE_CROSSROADS,
